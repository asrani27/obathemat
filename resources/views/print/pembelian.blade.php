  ...
  <section class="invoice">
    ...
    <div class="row">
      <div class="col-12 table-responsive">
        <div class="text-center"><h2><strong>LAPORAN DATA PEMBELIAN</strong></h2></div>
        <table class="table table-sm table-bordered" style="margin-bottom: 0px;">
          ...
          <tr>
            ...
            <th style="border: 2px solid black">Barang Yg Di beli</th>
          ...
          <tbody>
              @foreach ($data as $item)
                <tr>
                    ...
                    <td style="border: 2px solid black">{{$item->supplier->nama}}</td>
