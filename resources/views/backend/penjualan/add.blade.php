                ...
                <form class="form-horizontal" method="POST" action="{{route('penjualan')}}">
                  ...
                  <div class="card-body">
                    <div class="form-group row">
                      ...
                      <label for="inputEmail3" class="col-sm-2 col-form-label">Kustomer</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" name="kustomer" placeholder="nama kustomer" required>
                      </div>
                    </div>
                  ...
                  <tbody>
                      @foreach ($keranjang as $item)
                        <tr>
                            ...
                            <td>@currency($item->obat->harga_jual)</td>
                            <td>@currency($item->jumlah * $item->obat->harga_jual)</td>
                            <td>
