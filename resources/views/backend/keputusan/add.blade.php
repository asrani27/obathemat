        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-outline card-primary">
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{route('keputusan')}}">
                    @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="terjual" placeholder="0">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                          <select name="kategori" class="form-control" required>
                            <option value=""></option>
                                <option value="L">Laris</option>
                                <option value="TL">Tidak Laris</option>
                            </select>
                      </div>
                    </div>
